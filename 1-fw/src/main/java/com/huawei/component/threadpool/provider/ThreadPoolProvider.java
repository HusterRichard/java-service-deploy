package com.huawei.component.threadpool.provider;
...
import com.huawei.component.threadpool.provider.vo.ConfigThreadPoolVo;
...
public class ThreadPoolProvider {
	...
	protected void init(int iCorePoolSize4Bu, int iMaxPoolSize4Bu, long iKeepAliveSecond4Bu, int iQueueSize4Bu,
			int iCorePoolSize4Sys, int iMaxPoolSize4Sys, long iKeepAliveSecond4Sys, int iQueueSize4Sys) {
		if (0 == iCorePoolSize4Bu && 0 == iMaxPoolSize4Bu && 0 == iKeepAliveSecond4Bu && 0 == iQueueSize4Bu
				&& 0 == iCorePoolSize4Sys && 0 == iMaxPoolSize4Sys && 0 == iKeepAliveSecond4Sys
				&& 0 == iQueueSize4Sys) {
			return;
		}
	...
	public void submit4Bu(Runnable oTask) {
		if (null == this.threadPool4Bu && null == this.threadPool4Sys) {
			init(configThreadPoolVo.getBuCorePoolSize(), configThreadPoolVo.getBuMaxPoolSize(),
					configThreadPoolVo.getBuKeepAliveSecond(), configThreadPoolVo.getBuQueueSize(),
					configThreadPoolVo.getSysCorePoolSize(), configThreadPoolVo.getSysMaxPoolSize(),
					configThreadPoolVo.getSysKeepAliveSecond(), configThreadPoolVo.getSysQueueSize());
		}
